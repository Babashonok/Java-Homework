...
public class Vehicle implements Moveable{
    ...
    public Vehicle(double speed, double consumption100Km, int numberOfPassangers) {
        ...
        this.consumption100Km = validator.checkVariableThatCanBeZero(consumption100Km);
        this.numberOfPassangers = validator.checkIntVariableThatCannotBeZero(numberOfPassangers);
    }
